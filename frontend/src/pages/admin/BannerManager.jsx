    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-400">Create and manage promotional banners for your landing page</p>
        </div>
        <button
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-bold">All Banners ({banners.length})</h2>
        ...
        {banners.length === 0 ? (
          ...
          <div className="space-y-3">
            {banners.map((banner) => (
              <div
                key={banner.id}
                className="bg-gray-800 rounded-lg p-6 flex items-center gap-6 border border-gray-700 hover:border-purple-500/50 transition-all"
              >
              {/* Thumbnail */}
